...
public class viewmarks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url="http://"+sh.getString("ip","")+":5000/viewmark";

        RequestQueue queue = Volley.newRequestQueue(viewmarks.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    lv.setAdapter(new custom2(viewmarks.this,subject,marks));
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(viewmarks.this, "err"+error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
