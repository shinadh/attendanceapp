...
public class customperformance extends BaseAdapter{
    ...
    public customperformance(Context applicationContext, ArrayList<String> a, ArrayList<String> b,ArrayList<String> c) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_customperformance, null);
